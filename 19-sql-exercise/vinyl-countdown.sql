...
CREATE TABLE `records` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_collectors_to_records_idx` (`user_id`),
  CONSTRAINT `fk_collectors_to_records` FOREIGN KEY (`user_id`) REFERENCES `collectors` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-07-04 22:48:02
